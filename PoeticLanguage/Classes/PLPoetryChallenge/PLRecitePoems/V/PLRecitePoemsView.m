...
- (instancetype)init
{
    ...
    if (self) {
        ...
        if (_poetryArray.count == 0) {
            ...
            [self addSubview:_reciteTableView];
            ...
            _reciteTableView.frame = CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height - 200);
